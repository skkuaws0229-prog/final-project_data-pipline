...
| AlphaFold target 검색 | `GET /api/structures/targets?q=JAK&limit=10` | 200 | JAK1, JAK2, JAK3 반환 |
| AlphaFold 구조 목록 | `GET /api/structures?q=JAK&limit=10` | 200 | JAK1, JAK2, JAK3 구조 반환 |
